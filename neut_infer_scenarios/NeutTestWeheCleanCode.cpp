...
//
//NS_LOG_COMPONENT_DEFINE("NeutTestWeheCleanCode");
//
//#define PCAP_FLAG 0
//#define PACKET_MONITOR_FLAG 1
//
///*****************************************************************************/
//int run_neut_test_wehe_clean_code(int argc, char **argv) {
//    auto start = high_resolution_clock::now();
//
//    LogComponentEnable ("NeutTestWeheCleanCode", LOG_LEVEL_INFO);
...
//    uint32_t dstIds[nbServers]; for(int i = 0; i < nbServers; i++) { dstIds[i] = serverNodes.Get(i)->GetId(); }
//
