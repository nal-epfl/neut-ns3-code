 ...
 */
#ifndef TBF_QUEUE_DISC_CHILD_H
#define TBF_QUEUE_DISC_CHILD_H
 ...
 */
class TbfQueueDiscChild : public QueueDisc
{
public:
  ...
  /**
   * \brief TbfQueueDiscChild Constructor
   *
