 ...
 *
 */
class FifoQueueDiscCustom : public QueueDisc {
public:
  /**
  ...
  /**
   * \brief FifoQueueDiscCustom constructor
   *
   * Creates a queue with a depth of 1000 packets by default
   */
  FifoQueueDiscCustom ();

  virtual ~FifoQueueDiscCustom();
...
private:
  ...
  std::vector<FIFOEnqueueEvent> _enquedEvents;
